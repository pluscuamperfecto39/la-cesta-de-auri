...
- Cámara opcional para fotografiar cada producto y verlo en la cesta y el widget.
...
El archivo terminado está en `dist/La-Cesta-de-Auri-v1.9.0.apk`. En el móvil, abre el archivo y autoriza temporalmente la instalación desde esa fuente si Android lo solicita. En Android 13 o posterior, acepta el permiso de notificaciones para recibir recordatorios.
